...
class AuthState extends State<AuthController>{
      ...
      body: NotificationListener<OverscrollIndicatorNotification>(
        ...
        child: SingleChildScrollView(
          child: InkWell(
              ...
              child: Container(
                decoration: MyGradient(startColor: ColorTheme().pointer(),  endColor: ColorTheme().base()),
                width: MediaQuery.of(context).size.width,
                height: (MediaQuery.of(context).size.height > 700) ? MediaQuery.of(context).size.height : 700,
                child: SafeArea(
                  child: Column(
                    children: [
                      PaddingWith(child: Image.asset(logoImage, height: MediaQuery.of(context).size.height / 5)),
                      logOrCreateButtons(),
                      Expanded(
                        child: PageView(
                      ...
                      PaddingWith(
                          child: TextButton(
                            ...
                            child: Container(
                              ...
                              decoration: MyGradient(horizontal: true, radius: 25, startColor: ColorTheme().accent(), endColor: ColorTheme().pointer()),
  ...
  Widget logOrCreateButtons(){
    return Container(
      decoration: MyGradient(horizontal: true, startColor: ColorTheme().base(), endColor: ColorTheme().pointer(), radius: 25),
      width: 300,
      height: 50,
      child: CustomPaint(
  ...
  authToFirebase(){
    ...
    if (validText(mail) && validText(pwd)){
      ...
      //Alerte utilisateur pas de mail
